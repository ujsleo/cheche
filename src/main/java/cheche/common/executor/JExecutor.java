...
import cheche.common.threadpool.ThreadPoolBuilder;
import cheche.common.threadpool.ThreadPoolConstants;
...
public class JExecutor {
	...
	private JExecutor() {
		es.set(ThreadPoolBuilder.newThreadPool("JExecutor", // 线程池名
				500, // 线程池大小
				60, // 空闲线程存活时间(s)
